...
class AdminAuth:
    ...
    def __init__(self, base_url: str, username: str = "admin", password: str = "admin123",
                 ...
                 token_field: str = "access_token", verify_ssl: bool = True):
        """
        ...
        Args:
            ...
            verify_ssl: Whether to verify SSL certificates (default: True).
                       Set to False only for dev/test environments with self-signed certificates.
        """
    ...
    def login(self) -> bool:
        ...
        try:
            response = requests.post(login_url, json=payload, timeout=10, verify=self.verify_ssl)
