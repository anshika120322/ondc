...
Usage:
    ...
    # With custom TTL
    python func_test_scripts/generate_signature.py --version v2 --ttl 600 --payload '{"country": "IND"}'
...
Examples:
  ...
  python func_test_scripts/generate_signature.py --version v2 --payload '{"country": "IND", "type": "BPP"}'
